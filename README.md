# Amazon-Clone
🛒 Amazon Clone – Frontend Project Overview: Developed a static clone of the Amazon homepage using HTML and CSS, replicating the layout, design, and user interface of the original site. The project focused on building a clean, responsive, and visually accurate front-end without using any JavaScript or frameworks.
